	...
	<%@ include file="../include/header.jsp" %>
		...
		<%@ include file="../include/footer.jsp" %>
			...
			<script>
				...
				// 등록하기 버튼 눌렀는데 이미지 등록 안했을 시 기본 이미지 등록
				document.getElementById('partyRegisterBtn').onclick = () => {
					const $file = document.partyRegisterForm.file.value;
					console.log('파일 value : ' + $file);
					if ($file === '') {
						document.partyRegisterForm.file.value = 'C:/Users/User/2ndFile.htmlC://Work//group-project04(mid)-Yeoreobap//YeoreoBap//src//main//webapp//resources//imgthumbnail_3.jpg';
						console.log('바뀐 파일 value : ' + document.partyRegisterForm.file.value);
					}
				}
